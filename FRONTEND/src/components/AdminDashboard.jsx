...
const AdminDashboard = () => {
  ...
  const handleEditDoctor = async (id) => {
    ...
    try {
      await axios.put(
        `http://localhost:5000/api/admin/doctors/${id}/edit`,
        editDoctor,
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
  ...
  const handleBlockDoctor = async (id) => {
    ...
    try {
      await axios.put(
        `http://localhost:5000/api/admin/doctors/${id}/block`,
        {},
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
  ...
  const handleBlockPatient = async (id) => {
    ...
    try {
      await axios.put(
        `http://localhost:5000/api/admin/patients/${id}/block`,
        {},
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
  ...
  const handleUnblockPatient = async (id) => {
    ...
    try {
      await axios.put(
        `http://localhost:5000/api/admin/patients/${id}/unblock`,
        {},
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
  ...
  const handleRescheduleAppointment = async (id, originalDate) => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:5000/api/admin/appointments/${id}/reschedule`,
        { date: newDate },
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
      setAppointments(
